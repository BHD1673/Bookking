    ...
    <div class="cont">
        <div class="form sign-in">
            <form action="index2.php?act=dangnhap" method="post">
                ...
                <label>
                    <span>Email</span>
                    <input type="email" id="emailSignInInput" name="email" />
                ...
                <button type="submit" name="dangnhap" class="submit" onclick="signIn()"><a href="index.php">Sign In</a></button>
            </form>
        </div>
        <div class="sub-cont">
            <div class="img">
            ...
            <div class="form sign-up">
                <form action="index2.php?act=dangky" method="post">
                    ...
                    <button type="submit" name="dangky" class="submit" onclick="signUp()"><a href="index2.php?act=dangnhap">Sign Up</a></button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function signUp() {
            ...
            if (!passwordStrength.test(passwordSignUp)) {
                passwordSignUpError.textContent = 'Mật khẩu phải dài ít nhất 8 ký tự và bao gồm ít nhất một chữ cái viết thường, một chữ cái viết hoa và một chữ số.';
                return;
            } else {
                // Đăng ký thành công
