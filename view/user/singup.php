...
<br>
    ...
    <div class="form sign-in">
            ...
            <label>
                <span>Email</span>
                <input type="email" id="emailSignInInput" />
                <p class="error-message" id="emailSignInError"></p>
            </label>
            <label>
                <span>Password</span>
                <input type="password" id="passwordSignInInput" />
                <p class="error-message" id="passwordSignInError"></p>  
            </label>
            <p class="forgot-pass"><a href="index2.php?act=forgot">Forgot password?</a></p>
            <button type="button" class="submit" onclick="signIn()"><a href="index.php">Sign In</a></button>
</div>
        <div class="sub-cont">
            <div class="img">
  ...
  <button type="button" class="submit" onclick="signUp()"><a href="index2.php?act=dangnhap">Sign Up</a></button>
</div>
        </div>
    </div>
    ...
    if (!emailSignIn.trim()) {
      emailSignInError.textContent = 'Vui lòng nhập email';
      return;
    }
    ...
    if (!passwordSignIn.trim()) {
      passwordSignInError.textContent = 'Vui lòng nhập mật khẩu.';
      return;
    }
   ...
   function signUp() {
    ...
    if (!nameSignUp.trim()) {
      nameSignUpError.textContent = 'Vui lòng nhập tên của bạn.';
      return;
    }
    ...
    if (!emailFormat.test(emailSignUp.trim())) {
      emailSignUpError.textContent = 'Vui lòng nhập một email hợp lệ.';
      return;
    }
    ...
    if (!passwordStrength.test(passwordSignUp)) {
      passwordSignUpError.textContent = 'Mật khẩu phải bao gồm ít nhất 8 ký tự, có một chữ viết hoa, một thường, một số và một dấu câu';
      return;
    }
